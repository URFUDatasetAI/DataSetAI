...
from apps.labeling.api.v1.views import (
    ...
    TaskGeneratedApproveView,
    TaskGeneratedNoObjectView,
    TaskGeneratedRejectView,
    TaskRejectView,
...
urlpatterns = [
    ...
    path("tasks/<int:task_id>/generated/approve/", TaskGeneratedApproveView.as_view(), name="task-generated-approve"),
    path("tasks/<int:task_id>/generated/reject/", TaskGeneratedRejectView.as_view(), name="task-generated-reject"),
    path("tasks/<int:task_id>/generated/no-object/", TaskGeneratedNoObjectView.as_view(), name="task-generated-no-object"),
