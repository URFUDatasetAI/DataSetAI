...
from apps.rooms.api.v1.views import (
    ...
    RoomDatasetTaskListView,
    RoomDatasetUploadView,
    RoomDetailView,
    RoomInviteLinkView,
    RoomInviteView,
...
urlpatterns = [
    ...
    path("rooms/<int:room_id>/dataset/tasks/", RoomDatasetTaskListView.as_view(), name="room-dataset-task-list"),
    path("rooms/<int:room_id>/dataset/upload/", RoomDatasetUploadView.as_view(), name="room-dataset-upload"),
    path("rooms/<int:room_id>/dataset/delete/", RoomDatasetDeleteView.as_view(), name="room-dataset-delete"),
