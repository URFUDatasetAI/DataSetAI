...
1. [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) - обзор модулей, потоков данных и инженерных соглашений.
2. `apps/labeling/services.py` и `apps/rooms/services.py` - основная write-side бизнес-логика по задачам, импортам, доступу и экспорту.
